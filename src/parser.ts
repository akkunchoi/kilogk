...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c2 = function(time, chars) {
              return {type: 'record', time, chars}
          },
        peg$c3 = function(date) {
        ...
        peg$c9 = function(hour, minute) {
            return {hour, minute}
          },
        peg$c10 = function(hour) {
            return {hour}
          },
        peg$c11 = function(year, month, day) {
        ...
        peg$c24 = peg$otherExpectation("line separator"),
        peg$c25 = /^[\n\r]/,
    ...
    function peg$parseHeader() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseHeaderKeyword();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseSpace();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseDateFormat();
          if (s3 !== peg$FAILED) {
            peg$savedPos = s0;
            s1 = peg$c3(s3);
            s0 = s1;
    ...
    function peg$parseHeaderKeyword() {
      var s0;
